...
public class AlphaArray {
	...
	// public contstructor takes the amount of elements per line and fills the alpha array
	public AlphaArray(int elementsPerLine) { 
	...
	public static void main(String[] args) {
		AlphaArray fleming = new AlphaArray(10);
		System.out.println(fleming);
